package com.jwcnetworks.bsyoo.jwc.mainmenu.Company;
...
public class CompanyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayout.addTab(tabLayout.newTab().setText("연혁"));
        tabLayout.addTab(tabLayout.newTab().setText("팀별소개"));

        // ViewPager 초기화
        final ViewPager viewPager = (ViewPager) findViewById(R.id.view_pager);

        // PagerAdater 생성
        CompanyTabPagerAdapter pagerAdapter = new CompanyTabPagerAdapter(getSupportFragmentManager(), tabLayout.getTabCount());
