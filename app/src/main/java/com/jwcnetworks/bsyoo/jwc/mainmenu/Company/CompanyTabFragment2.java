...
import com.jwcnetworks.bsyoo.jwc.adapter.AdapterCompany;
import com.jwcnetworks.bsyoo.jwc.model.ModelCompany;
...
public class CompanyTabFragment2 extends CompanyFragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        // 머리 아이템
        headerView = getActivity().getLayoutInflater().inflate(R.layout.listitem_cases_header, null);
