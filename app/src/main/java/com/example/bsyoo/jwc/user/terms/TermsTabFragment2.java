...
public class TermsTabFragment2 extends TermsFragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        tv_termsinfo2.setText("개인정보의 수집목적 및 이용목적\n" +
                "① JWC몰은 회원님께 최대한으로 최적화되고 맞춤화된 서비스를 제공하기 위하여 다음과 같은 목적으로 개인정보를 수집하고 있습니다. \n" +
                ...
                "개인정보의 수집범위\n" +
                "JWC몰은 별도의 회원가입 절차 없이 대부분의 컨텐츠에 자유롭게 접근할 수 있습니다. JWC몰의 회원제 서비스를 이용하시고자 할 경우 다음의 정보를 입력해주셔야 하며 선택항목을 입력하시지 않았다 하여 서비스 이용에 제한은 없습니다. \n" +
                ...
                "② 귀하의 동의를 받아 보유하고 있는 거래정보 등을 귀하께서 열람을 요구하는 경우 JWC몰은 지체없이 그 열람,확인 할 수 있도록 조치합니다.");
    }
}
